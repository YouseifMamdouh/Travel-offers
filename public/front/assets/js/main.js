(function($) {
    ...
    var myWave = $('#ht-wavify , #ht-wavify-lg').wavify({
        height: 100,
        bones: 3,
        amplitude: 100,
        color: '#f6f5f9',
    ...
    var myWave = $('#ht-wavify_down').wavify({
        height: 100,
        bones: 2,
        amplitude: 100,
        color: '#f6f5f9',
    ...
    var myWave = $('#ht-wavify_white').wavify({
        height: 100,
        bones: 3,
        amplitude: 50,
        color: '#fff',
    ...
    var myWave = $('#ht-wavify_drak').wavify({
        height: 40,
        bones: 4,
        amplitude: 40,
        color: '#33237a',
    ...
    var myWave = $('.ht-wavify-drak_hero').wavify({
        height: 40,
        bones: 4,
        amplitude: 40,
        color: '#2D1B6E',
    ...
    var myWave = $('#ht-wavify-bg-theme-two').wavify({
        height: 100,
        bones: 4,
        amplitude: 100,
        color: '#161953',
