...
(function($) {
    ...
    $(window).on('load', function() {
        ...
        $('.loader-wrapper, .skeleton_loader').fadeOut(100);
        $('.loader-wrapper, .skeleton_loader').remove(100);
    });
    ...
    $(".open-select").click(function() {
        $(this).parent().find(".selector-box, .selector-box-service").addClass("show");
    });
    ...
    $(".modify-search").click(function() {
        $(".service-search-detail").addClass("show");
    });
    $(".responsive-close").click(function() {
        $(".service-search-detail").removeClass("show");
    });
...
$(document).mouseup(function(e) {
    var container = $(".open-select, .selector-box, .selector-box-service, .fare-calender, .setting");

    if (!container.is(e.target) &&
        container.has(e.target).length === 0) {
        $(".selector-box, .selector-box-service, .calender-external, .setting-open").removeClass("show");
    }
});
