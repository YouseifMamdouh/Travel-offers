                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            ...
                                            <i class="ki-duotone ki-plus fs-2"></i>إضافة موظف
                                        </button>
                                        <!--end::Add user-->
                                    </div>
                                    <!--end::Toolbar-->
                                                    ...
                                                    <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7"
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-semibold fs-6 mb-2">اسم
                                                                    الموظف</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-semibold fs-6 mb-2">البريد
                                                                    الإلكتروني</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                <!--begin::Label-->
                                                                <label class="required fw-semibold fs-6 mb-2">كلمة
                                                                    المرور</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                            ...
                                                            <div class="row mb-7">
                                                                <div
                                                                    class="col-xxl-12 col-xl-12 col-md-12 col-sm-12 col-12">
                                                                    <h4>المسمي الوظيفي</h4>
                                                                </div>
                                                                @if(isset($roles) && $roles->count() > 0)
                                                                    @foreach($roles as $role)
                                                                        <div
                                                                            class="col-xxl-6 col-xl-6 col-md-6 col-sm-6 col-12 mb-4 px-5">
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-100px" style="text-align: right">اسم الموظف</th>
                                    <th class="min-w-100px" style="text-align: right">البريد الإلكتروني</th>
                                    <th class="min-w-100px" style="text-align: right">المسمي الوظيفي</th>
                                ...
                                @if(isset($data))
                                    @foreach($data as $key => $item)
                                        ...
                                        <tr id="row_{{$item->id}}">
                                            ...
                                            <td>
                                                <span>{{$item->roles->count()? $item->roles->first()->name : ''}}</span>
                                            </td>
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <!--end::Menu item-->
                                                    ...
                                                    @if(auth()->user()->can('user.delete') )
                                                        ...
                                                        <div class="menu-item  px-3">
                                                            <form method="post"
                                                                  action="{{route('admins.destroy', $item->id)}}"
                                                                  class="delete_locale">
                                                                @csrf
                                                                @method('DELETE')
    ...
    <script>
        $(document).ready(function () {
            ...
            delete_li.on('click', function (e) {
                ...
                let id = form_locale.find('input[name="admin_id"]').val();
                if (id !== "") {
                    Swal.fire({
                        text: "هل أنت متأكد؟",
                        icon: "warning",
