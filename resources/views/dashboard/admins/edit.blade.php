            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        <!--begin::Table-->
                        <form action="{{route('admins.update', $data->id)}}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" value="{{$data->name}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Admin Name" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="fw-semibold fs-6 mb-2 required"  for="email">Email</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" value="{{$data->email}}" type="email" id="email" name="email" placeholder="Admin Email">
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" type="password" id="password" name="password" placeholder="Admin Password">
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
