                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('countries.index')}}" class="text-muted text-hover-primary">Countries</a> <span class="px-2"> - </span>
                                <span> Edit </span>
                            </li>
                            <!--end::Item-->
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <div class="row px-0">
                            <div class="col-lg-4 col-md-4 col-sm-7 col-12 m-auto">
                                <img src="{{asset('uploads/countries/'. $data->image)}}" alt="Country" class="w-100">
                            </div>
                        </div>
                        <!--begin::Table-->
                        <form action="{{route('countries.update', $data->id)}}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="title" value="{{$data->title}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Country Name" />
                                <!--end::Input-->
                            </div>
                            <!-- begin::Input group-->
                            <div class="fv-row mb-7">
