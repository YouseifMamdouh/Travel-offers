                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('cities.index')}}" class="text-muted text-hover-primary">Cities</a>
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <!--begin::Add user-->
                                <a type="button" class="btn btn-primary" href="{{route('cities.edit', $data->id)}}">
                                    Edit
                        ...
                        <div class="row px-0 mt-3">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item bold">
                                        <img src="{{asset('uploads/cities/' . $data->image)}}" alt="" class="w-100">
                                    </div>
                                </div>
                            </div>
                        </div>
