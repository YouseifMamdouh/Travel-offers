                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        <div class="row px-0">
                            <div class="col-lg-4 col-md-4 col-sm-7 col-12 m-auto">
                                <img src="{{asset('uploads/hotels/'. $data->banner)}}" alt="Banner" class="w-100">
                            </div>
                        </div>
                        <!--begin::Table-->
                        <form action="{{route('hotels.update', $data->id)}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <textarea name="description" class="form-control form-control-solid mb-3 mb-lg-0" id="editor" placeholder="Hotel Description">{{$data->description}}</textarea>
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="city_id" id="city_id" style="width: 100%">
                                    @if(isset($data->country_id))
                                        @php($cities_inside = App\Models\City::where('country_id', $data->country_id)->get())
                                    @endif
                                    @if(isset($cities_inside) && $cities_inside->count() > 0)
                                        @foreach($cities_inside as $city)
