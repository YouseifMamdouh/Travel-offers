                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{route('dashboard')}}"
                                   class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> Hotels </span>
                            </li>
                            <!--end::Item-->
                        ...
                        <div class="card-header border-0 pt-6">
                            ...
                            <div class="card-toolbar">
                                ...
                                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                    <!--begin::Add user-->
                                    <a type="button" class="btn btn-primary" href="{{route('hotels.create')}}">
                                        Add Hotel<i class="ki-duotone ki-plus fs-2"></i></a>
                                    <!--end::Add user-->
                                </div>
                                <!--end::Toolbar-->
...
{{--                                                <!--begin::Form-->--}}
{{--                                                <form id="kt_modal_add_user_form" class="form" method="post" action="{{route('hotels.store')}}" enctype="multipart/form-data">--}}
{{--                                                    @csrf--}}
{{--                                                    <!--begin::Scroll-->--}}
...
{{--                                                        <div class="fv-row mb-7">--}}
{{--                                                            <!--begin::Label-->--}}
{{--                                                            <label class="required fw-semibold fs-6 mb-2" for="title">Location</label>--}}
{{--                                                            <!--end::Label-->--}}
{{--                                                            <!--begin::Input-->--}}
...
{{--                                                            <!--end::Label-->--}}
{{--                                                            <!--begin::Input-->--}}
{{--                                                            <input type="number" name="rooms_num" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Rooms Number" />--}}
{{--                                                            <!--end::Input-->--}}
{{--                                                        </div>--}}
{{--                                                        <!--begin::Input group-->--}}
{{--                                                    </div>--}}
...
{{--                                            </td>--}}
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('hotels.show_rooms', $item->id)}}"
                                                           class="menu-link px-3"> Show Rooms</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('hotels.addImages', $item->id)}}"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item  px-3">
                                                        <form method="post" action="{{route('hotels.destroy', $item->id)}}"
                                                              class="delete_locale">
                                                            @csrf
                                                            @method('DELETE')
                ...
                if (id !== "") {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{url('admin/hotels/delete')}}/" + id,
