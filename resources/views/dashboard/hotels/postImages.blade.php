...
@section('title', 'Add Images to Hotel ')
@section('content')
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <!--begin::Table-->
                        <form action="{{route('hotels.postImages', $data->id)}}"  enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input class="form-control form-control-solid" multiple type="file" id="formFile" name="hotel_images[]">
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
