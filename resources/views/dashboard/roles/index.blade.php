                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                                            <i class="ki-duotone ki-plus fs-2"></i>إضافة وظيفة</button>
                                        <!--end::Add user-->
                                    </div>
                                    <!--end::Toolbar-->
                                        ...
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-header" id="kt_modal_add_user_header">
                                                    <!--begin::Modal title-->
                                                    <h2 class="fw-bold">إضافة وظيفة</h2>
                                                    <!--end::Modal title-->
                                                    <!--begin::Close-->
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_add_user_form" class="form" method="post" action="{{route('roles.store')}}">
                                                        @csrf
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="اسم الوظيفة" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                                ...
                                                                @if(isset($perms) && $perms->count() > 0)
                                                                    @foreach($perms as $perm)
                                                                        ...
                                                                        <div class="form-check">
                                                                            <input class="form-check-input" type="checkbox" id="perm_{{$perm->id}}" name="perms[{{$perm->id}}]">
                            ...
                            <div class="card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px" style="text-align: right">اسم الوظيفة</th>
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('roles.show', $item->id)}}"
                                                           class="menu-link px-3">عرض التفاصيل</a>
                                                    </div>
                                                    <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item px-3">
    ...
    <script>
        $(document).ready(function () {
            ...
            delete_li.on('click', function (e) {
                ...
                let id = form_locale.find('input[name="role_id"]').val();
                if (id !== "") {
                    Swal.fire({
                        text: "هل أنت متأكد؟",
                        icon: "warning",
