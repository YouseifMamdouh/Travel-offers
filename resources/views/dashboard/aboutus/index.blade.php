                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{route('dashboard')}}"
                                   class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> About us </span>
                            </li>
                            <!--end::Item-->
...
{{--                                        Add (About us Image)<i class="ki-duotone ki-plus fs-2"></i></button>--}}
{{--                                    <!--end::Add user-->--}}
{{--                                </div>--}}
{{--                                <!--end::Toolbar-->--}}
...
{{--                                                <!--begin::Modal title-->--}}
{{--                                                <h2 class="fw-bold">Add (About us Image)</h2>--}}
{{--                                                <!--end::Modal title-->--}}
{{--                                                <!--begin::Close-->--}}
...
{{--                                                <!--begin::Form-->--}}
{{--                                                <form id="kt_modal_add_user_form" class="form" method="post" action="{{route('aboutus.store')}}" enctype="multipart/form-data">--}}
{{--                                                    @csrf--}}
{{--                                                    <!--begin::Scroll-->--}}
...
{{--                                                            <!--end::Label-->--}}
{{--                                                            <!--begin::Input-->--}}
{{--                                                            <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="About us Image title" />--}}
{{--                                                            <!--end::Input-->--}}
{{--                                                        </div>--}}
{{--                                                        <!--begin::Input group-->--}}
{{--                                                        <div class="fv-row mb-7">--}}
...
{{--                                                            <!--end::Label-->--}}
{{--                                                            <!--begin::Input-->--}}
{{--                                                            <textarea name="description" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="About us Image Description"></textarea>--}}
{{--                                                            <!--end::Input-->--}}
{{--                                                        </div>--}}
{{--                                                        <!--end::Input group-->--}}
{{--                                                        <!--begin::Input group-->--}}
...
{{--                                            <td class="min-w-50px" style="text-align: center"><a href="{{asset('uploads/aboutus/' . $item->image)}}" target="_blank"><img src="{{asset('uploads/aboutus/'.$item->image)}}" alt="Image" style="width: 50px"></a></td>--}}
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('aboutus.show', $item->id)}}"
