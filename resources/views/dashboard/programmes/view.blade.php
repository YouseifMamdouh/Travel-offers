                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('programmes.index')}}" class="text-muted text-hover-primary">Programmes</a>
                                ...
                                @foreach($data->progImages as $image)
                                    ...
                                    <div
                                        ...
                                        <a href="{{asset('uploads/programmes/'. $image->image)}}" target="_blank">
                                            <img src="{{asset('uploads/programmes/'. $image->image)}}" alt="image"
                                                 class="w-100">
                                        </a>
                                    </div>
                                @endforeach
                        ...
                        <div class="row px-0 mt-3">
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-12 col-12 m-auto text-left">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-6  text-left details_item bold">
                                        <a href="{{asset('uploads/programmes/' . $data->cover)}}" target="_blank"><img src="{{asset('uploads/programmes/' . $data->cover)}}" alt="cover" class="w-100"></a>
                                    </div>
                                </div>
                            </div>
