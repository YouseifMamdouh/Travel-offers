                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{route('dashboard')}}"
                                   class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> Programmes </span>
                            </li>
                            <!--end::Item-->
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('programmes.show', $item->id)}}"
                                                           class="menu-link px-3"> View</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('programmes.addImages', $item->id)}}"
                                                           class="menu-link px-3"> Add Images</a>
                                                    </div>
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('programmes.edit', $item->id)}}"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item  px-3">
                                                        <form method="post" action="{{route('programmes.destroy', $item->id)}}"
                                                              class="delete_locale">
                                                            @csrf
                                                            @method('DELETE')
                ...
                if (id !== "") {
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{url('admin/programmes/delete')}}/" + id,
