                    ...
                    <div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
                        ...
                        <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <!--end::Item-->
                                <!--begin::Item-->
                                <li class="breadcrumb-item text-muted">اللغات</li>
                                <!--end::Item-->
                            </ul>
                            <!--end::Breadcrumb-->
                        </div>
                                ...
                                <div class="card-toolbar">
                                    ...
                                    <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#kt_modal_add_user">
                                            <i class="ki-duotone ki-plus fs-2"></i>إضافة لغة</button>
                                        <!--end::Add user-->
                                    </div>
                                    <!--end::Toolbar-->
                                    <!--begin::Modal - Add task-->
                                    <div class="modal fade" id="kt_modal_add_user" tabindex="-1" aria-hidden="true" dir="ltry">
                                        <!--begin::Modal dialog-->
                                        <div class="modal-dialog modal-dialog-centered mw-650px">
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                                                    <!--begin::Form-->
                                                    <form id="kt_modal_add_user_form" class="form" method="post" action="{{route('web.locale.store')}}">
                                                        @csrf
                                                        <!--begin::Scroll-->
                                                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_add_user_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                                                            ...
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="title" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="اسم اللغة" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                            <!--begin::Input group-->
                                                            <div class="fv-row mb-7">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="shorthand" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="الإختصار"  />
                                                                <!--end::Input-->
                                                            </div>
                                                            <!--end::Input group-->
                                                        </div>
                            ...
                            <div class="card-body py-4">
                                ...
                                <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                    ...
                                    <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                        ...
                                        <th class="min-w-100px" style="text-align: right">الأختصار</th>
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('web.locale.edit', $item->id)}}"
                                                           class="menu-link px-3"> تعديل</a>
                                                    </div>
                                                    @endif
                                                    @if(auth()->user()->can('locale.delete') )

                                                        <!--end::Menu item-->
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item  px-3">
                                                        <form method="post" action="{{route('web.locale.destroy', $item->id)}}"
                                                           class="delete_locale">
                                                            @csrf
                                                            @method('DELETE')
                                                            <input type="hidden" value="{{$item->id}}" name="locale_id">
                                                            <button class="menu-link delete_btn_li px-3 w-100" type="submit">حذف</button>
                                                        </form>
                                                    </div>
                                                        @endif
                                                    <!--end::Menu item-->
                ...
                if (id !== "") {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "/admin/web-locale/delete/" + id,
                                data: {
                                    _token: "{{csrf_token()}}",
                                    _method: "DELETE",
                                    id: id,
