                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href="{{route('dashboard')}}"
                                   class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> Contact us </span>
                            </li>
                            <!--end::Item-->
                        ...
                        <div class="card-body py-4">
                            ...
                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-50px" style="text-align: center">Email</th>
                                ...
                                @if(isset($data))
                                    @foreach($data as $key => $item)
                                        ...
                                        <tr id="row_{{$item->id}}">
                                            ...
                                            <td class="min-w-50px" style="text-align: center"><a href="{{asset('uploads/contacts/' . $item->image)}}" target="_blank"><img src="{{asset('uploads/contacts/'.$item->image)}}" alt="Image" style="width: 50px"></a></td>
