                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('contacts.index')}}" class="text-muted text-hover-primary">Contact us</a> <span class="px-2"> - </span>
                                <span> Edit </span>
                            </li>
                            <!--end::Item-->
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <div class="row px-0">
                            <div class="col-lg-4 col-md-4 col-sm-7 col-12 m-auto text-center">
                                <img src="{{asset('uploads/contacts/'. $data->image)}}" alt="image" class="w-50">
                            </div>
                        </div>
                        <!--begin::Table-->
                        <form action="{{route('contacts.update', $data->id)}}" enctype="multipart/form-data" method="post">
                            @csrf
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="email" name="email" value="{{$data->email}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="email" />
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="address" value="{{$data->address}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="address" />
                                <!--end::Input-->
                            </div>
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="phone" value="{{$data->phone}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="phone" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
