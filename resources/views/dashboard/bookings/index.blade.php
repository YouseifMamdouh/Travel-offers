                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <li class="breadcrumb-item text-muted">
                                    <a href="{{route('dashboard')}}"
                                       class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> Bookings </span>
                                </li>
                                <!--end::Item-->
...
{{--                                        </th>--}}
                                        ...
                                        <th class="" style="text-align: center">Service</th>
                                        <th class="" style="text-align: center">Email</th>
                                        <th class="min-w-50px" style="text-align: center">Phone</th>
                                        <th class="min-w-50px" style="text-align: center">Address</th>
