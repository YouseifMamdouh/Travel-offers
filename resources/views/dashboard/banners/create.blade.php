                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('banners.index')}}" class="text-muted text-hover-primary">Banners</a> <span class="px-2"> - </span>
                                <span> Add </span>
                            </li>
                            <!--end::Item-->
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <form action="{{route('banners.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="title" id="title" value="{{old('title')}}" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="Banner Title" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                            <!--begin::Input group-->
                            <div class="fv-row mb-7">
                                <!--begin::Label-->
                                <label class="fw-semibold fs-6 mb-2" for="formFile">Image</label>
                                <!--end::Label-->
                                <!--begin::Input-->
