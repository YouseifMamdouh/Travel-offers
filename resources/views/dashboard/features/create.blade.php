                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <form action="{{route('features.store')}}" enctype="multipart/form-data" method="post">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" value="{{old("name")}}" name="name" class="form-control form-control-solid mb-3 mb-lg-0" placeholder="features Name" />
                                <!--end::Input-->
                            </div>
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <select name="type_of" id="type_of" style="width: 100%">
                                    <option value="hotels" {{old("type_of") == 'hotels' ? 'selected' : ''}}>Hotels</option>
                                    <option value="programmes" {{old("type_of") == 'programmes' ? 'selected' : ''}}>Programmes</option>
                                </select>
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
