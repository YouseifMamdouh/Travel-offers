...
@section('title', 'About us Details Edit')
@section('content')
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                ...
                                <a href="{{route('aboutus_details.index')}}" class="text-muted text-hover-primary">About us Details</a> <span class="px-2"> - </span>
                                <span> Edit </span>
                            </li>
                            <!--end::Item-->
            ...
            <div id="kt_app_content" class="app-content flex-column-fluid">
                ...
                <div class="card">
                    ...
                    <div class="card-body py-4" dir="{{Config::get('app.locale') == 'en' ? 'ltr' : 'rtl'}}">
                        ...
                        <!--begin::Table-->
                        <form action="{{route('aboutus_details.update', $data->id)}}" enctype="multipart/form-data" method="post">
                            @csrf
