                            ...
                            <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                                ...
                                <li class="breadcrumb-item text-muted">
                                    <a href="{{route('dashboard')}}"
                                       class="text-muted text-hover-primary">Dashboard</a> <span class="px-2"> - </span> <span> Messages </span>
                                </li>
                                <!--end::Item-->
...
{{--                                                    <!--begin::Form-->--}}
{{--                                                    <form id="kt_modal_add_user_form" class="form" method="post" action="{{route('blogs.store')}}" enctype="multipart/form-data">--}}
{{--                                                        @csrf--}}
{{--                                                        <!--begin::Scroll-->--}}
...
{{--                                            </div>--}}
{{--                                        </th>--}}
                                        <th class="min-w-50px" style="text-align: center">First Name</th>
                                        <th class="min-w-50px" style="text-align: center">Last Name</th>
                                        <th class="" style="text-align: center">Email</th>
                                        <th class="min-w-50px" style="text-align: center">Phone</th>
                                        <th class="min-w-50px" style="text-align: center">Message</th>
                                            ...
                                            <td class="text-end" style="text-align: center!important;">
                                                ...
                                                <div
                                                    ...
                                                    <div class="menu-item px-3">
                                                        <a href="{{route('contact_messages.show', $item->id)}}"
                                                    ...
                                                    <!--begin::Menu item-->
                                                    <div class="menu-item  px-3">
                                                        <form method="post" action="{{route('contact_messages.destroy', $item->id)}}"
                                                           class="delete_locale">
                                                            @csrf
                                                            @method('DELETE')
                ...
                if (id !== "") {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                url: "{{url('admin/contact_messages/delete')}}/" + id,
