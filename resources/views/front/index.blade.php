...
@section('content')
                    ...
                    <div class="col-12 col-lg-12 col-md-12">
                        ...
                        <div class="flight-5 no-arrow row justify-content-center" style="z-index: 100;position:relative;">
                            @if (isset($latest_services) && $latest_services->count() > 0)
                                ...
                                @endforeach
                            @endif
                            <a class="col-lg-3 col-md-3 col-sm-6 col-6 single_service" target="_blank"
                                ...
                                <div class="single_service_div">
                                    <div class="tourBox wow zoomIn">
                                        <div class="tourImg" style="border-radius: 0;">
                                            <img src="{{ asset('front/assets/images/eng.png') }}"
                                                class="img-fluid blur-up lazyload bg-img" alt="" style="">
                                        </div>
                                        <div class="tourContent">
                                            <h3>تعلم اللغة الإنجليزية</h3>
                                        </div>
                                    </div>
                                </div>
                            </a>
    ...
    <section class="services-section py-4" dir="rtl">
    ...
    <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2">
                <h2 class="custom_title">سافر الى اى مكان </h3>
            </div>
                                ...
                                <div class="bg_img">
                                    ...
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            ...
                                            <p>لا كليه شنزليزيه باري باي ذا كريست كوليكشن</p>
                                        </div>
                                    </div>
                                </div>
                            </a>
                            ...
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    ...
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            <h2 class="mb-3">تايلاند</h2>
                                            <p>لا فندق وريزيدنس إس إل إس دبي
                                                فندق
                                            </p>
                                        </div>
                                    </div>
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title">أشهر الفنادق في السعودية</h2>
            </div>
            <div class="slider_333">
                <div>
                    <div class="blog-wrap position-relative">
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title">أبرز الأنشطة الصيفية</h2>
            </div>
            <div class="slider_333">
                <div>
                    <div class="blog-wrap position-relative">
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    <img src="{{ asset('front/assets/img/team_.webp') }}"
                                        class="img-fluid blur-up lazyload bg-img-other" alt="">
                                    <div class="overlay"></div>
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            <h5 class="mb-3">تذكرة تيم لاب فينومينا أبوظبي</h5>
                                            <p>أبوظبي</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div>
                    <div class="blog-wrap position-relative">
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    <img src="{{ asset('front/assets/img/go_.webp') }}"
                                        class="img-fluid blur-up lazyload bg-img-other" alt="">
                                    <div class="overlay"></div>
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                ...
                <div>
                    <div class="blog-wrap position-relative">
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    <img src="{{ asset('front/assets/img/day_x.webp') }}"
                                        class="img-fluid blur-up lazyload bg-img-other" alt="">
                                    <div class="overlay"></div>
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                ...
                <div>
                    <div class="blog-wrap position-relative">
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    <img src="{{ asset('front/assets/img/louvre-.webp') }}"
                                        class="img-fluid blur-up lazyload bg-img-other" alt="">
                                    <div class="overlay"></div>
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                                ...
                                                <div class="col-lg-12 col-12 ">
                                                    <div class="row mt-4 facility_row">
                                                        ...
                                                        @foreach ($all_features as $feature)
                                                            <div
                                                                class="col-md-3 col-3 px-0 {{ in_array($feature->id, $prog_features) ? '' : 'd-none' }} ">
        ...
        <div class="container mini_container">
            ...
            <div class="slider-container">
                <div class="slider-wrapper">
                    <div class="slide-3 no-arrow" id="airlinesSlider">
                        <div class="airline-card">
                            <div class="blog-wrap">
                                <div class="blog-image">
                                    <div class="airline-logo">
                                        <img style="height: 160px" src="{{ asset('front/assets/img/logo-9.webp') }}"
                                            class="img-fluid w-100" alt="">
                                    </div>
                                </div>
                                <div class="destination-details text-center">
                                    <h3>الخطوط الجوية القطرية</h3>
                                </div>
                            </div>
                        </div>
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title">اكتشف أكثر الوجهات رواجاً</h2>
            </div>
   ...
   <section class="banner_section mb-5">
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title"> دليلك لأشهر الوجهات الدولية</h2>
            </div>
            <div class="slider_333">
                <div>
                    <div class="blog-wrap position-relative">
                            ...
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    <img src="{{ asset('front/assets/images/georgia.jpg') }}"
                                        class="img-fluid blur-up lazyload bg-img-other" style="height: 100%;display: none"
                                        alt="">
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            <h2 class="text-center">جورجيا</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title">دليلك لأشهر الوجهات المحلية</h2>
            </div>
            <div class="slider_333">
                        ...
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    ...
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            <h2 class="text-center">الرياض</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="blog-image destination_custom_img_">
                            <a href="javascript:void(0);">
                                <div class="bg_img">
                                    ...
                                    <div class="row destination_details_custom_">
                                        <div class="col-lg-12 col-12">
                                            <h2 class="text-center">الطائف</h2>
                                        </div>
                                    </div>
                                </div>
                            </a>
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title">اكتشف أجمل ما في المملكة العربية السعودية
                </h2>
            </div>
            <div class="slide-3 no-arrow">
                @if (isset($countries) && $countries->count() > 0)
    ...
    {{-- <section class="blog_section destination-section section-b-space ratio_55">
        <div class="container mini_container">
            <div class="title-2 mb-4">
                <h2 class="custom_title"> {{ \App\Helpers\TranslationHelper::translate('Top Destinations', 'site') }}
                </h2>
            </div>
            <div class="slider_333">
                <div>
