...
@section('content')
    ...
    <section class="section-b-space dark-cls">
        <img src="{{ asset('front') }}/assets/images/cab/grey-bg.jpg" alt="" class="img-fluid blur-up lazyload bg-img">
        <div class="container">
            <div class="title-1">
                    ...
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="{{ asset('front') }}/assets/images/avtar/1.jpg" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                ...
                <div>
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="{{ asset('front') }}/assets/images/avtar/2.jpg" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                                        <i class="fas fa-comments"></i>
                                        <i class="fas fa-comments light"></i>
                                    </div>
                ...
                <div>
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            <div class="testimonial">
                                <div class="left-part">
                                    <img src="{{ asset('front') }}/assets/images/avtar/3.jpg" class="img-fluid blur-up lazyload" alt="">
                                    <div class="design">
                                        <i class="fas fa-comments"></i>
                                        <i class="fas fa-comments light"></i>
                                    </div>
