                        ...
                        <div class="footer-content">
                            <div class="contact-detail">
                                ...
                                <ul class="contact-list">
                                    ...
                                    <li><i class="fas fa-phone-alt"></i>920011391</li>
                                    <li><i class="fas fa-envelope"></i>info@raltravel.com</li>
                                </ul>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="row">
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/1.jpg') }}"
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/2.jpg') }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <div class="overlay">
                                                    <h6>beach</h6>
                                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/3.jpg') }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <div class="overlay">
                                                    <h6>newyork</h6>
                                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/4.jpg') }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <div class="overlay">
                                                    <h6>city</h6>
                                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/5.jpg') }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <div class="overlay">
                                                    <h6>mountain</h6>
                                                </div>
                                    ...
                                    <div class="col-4">
                                        <div class="place rounded5">
                                            <a href="#">
                                                <img src="{{ asset('front/assets/images/tour/footer/6.jpg') }}"
                                                    class="img-fluid blur-up lazyload" alt="">
                                                <div class="overlay">
                                                    <h6>wild</h6>
                                                </div>
