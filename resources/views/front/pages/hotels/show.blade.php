                    ...
                    <div class="owl-carousel owl-theme hotel_images" dir="ltr">
                        @foreach ($hotel->hotelImages as $k => $single_image)
                            <div class="item" style="height: 66vh;width: 100%">
                                <img src="{{ asset('uploads/hotels/' . $single_image->image) }}" alt="image"
                        ...
                        {{-- <div class="description-section tab-section">
                            <div class="menu-top menu-up">
                                <ul class="nav nav-tabs" id="top-tab" role="tablist">
                                    ...
                                    <li class="nav-item"><a data-bs-toggle="tab" class="nav-link " href="#rooms">الغرف</a>
                                    </li>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            @if (count($room->roomImages) > 0)
                                                                <a href="#">
                                                                    <img src="{{ asset('uploads/rooms/' . $room->roomImages->first()->image) }}"
                                                                            ...
                                                                            <ul>
                                                                                @if (count($room->features) > 0)
                                                                                    @foreach ($room->features as $feature)
                                                                                        <li><img src="{{ asset('uploads/features/' . $feature->icon) }}"
                                                        ...
                                                        <td>
                                                            <div class="price-details"
                                                                style="margin-left: {{ $room->price < 1 ? '50px' : '0' }}">
                                                                <div>
                                                                    @if ($room->price > 0)
                                                                        ...
                                                                        <h5>{{ $room->price . General::getCurrency() }}
                                                                            <span class="text-muted d-inline-block"
                                                                                style="font-size: 15px;font-weight: normal">/لكل
                                                                                ليلة</span>
                                                                        </h5>
                                                                    @endif
                                        ...
                                        <div>
                                            <div class="special-box p-0">
                                                ...
                                                <div class="special-content">
                                                    ...
                                                    <h5 class="mt-1">
                                                        <span class="ms-0"><i class="fas fa-map-marker-alt"></i>
                                                            {{ $single_hotel->country->title }},
                                                            {{ $single_hotel->city->title }}</span>
                                                    </h5>
