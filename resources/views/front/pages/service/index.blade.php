...
{{--                                                </div>--}}
                    ...
                    <nav aria-label="breadcrumb" class="theme-breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">{{$service->title}}</li>
                        </ol>
                    </nav>
                </div>
            </div>
                                    ...
                                    <div class="col-md-12">
                                        <form method="post" action="{{route('book.service', $service->id)}}">
                                            ...
                                            <div class="continue-btn">
                                                <button class="btn btn-solid" type="submit">تأكيد الحجز</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
    ...
    <div class="book-panel">
        ...
        <button type="button" onclick="window.location.href='service-booking-addons.html'"
                class="btn bottom-btn theme-color">continue
        </button>
    </div>
